...
public class FileContentDataDaoImpl extends FileContentDataDao
{
	...
	public FileContentDataDaoImpl() {
		fileContentDatas.add(createDataset("readme.txt", encode("bla"), 123L, "ich", "10.10.2000"));
		fileContentDatas.add(createDataset("logo.jpg", IMAGE, 123L, "ich", "10.10.2000"));
		fileContentDatas.add(createDataset("script.groovy", encode("do it"), 123L, "ich", "10.10.2000"));
	}
	...
	public FileContentData create(FileContentData fileContentData) {
		Date now = new Date();
		String content = fileContentData.getContent();
