...
import { FilemanListLayout } from './fileman-list-layout.component';
...
describe('FilemanListLayout', () => {
  let component: FilemanListLayout;
  let fixture: ComponentFixture<FilemanListLayout>;

  beforeEach(() => {

    TestBed.configureTestingModule({
      declarations: [ FilemanListLayout ],
      imports: [ RouterTestingModule, HttpClientModule ]
    });

    fixture = TestBed.createComponent(FilemanListLayout);
