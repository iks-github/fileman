...
{
	private static final long serialVersionUID = 1610006277671L;
    ...
    @JoinTable(name="user_tenant", joinColumns = { @JoinColumn(name = "fk_tenant") }, inverseJoinColumns = { @JoinColumn(name = "fk_user") })
	...
	public Object clone()
	{
		...
		if ( this.users != null )
		{
			final  java.util.List<User> listUser = new java.util.ArrayList<User>();
